...
st.markdown("""
    <style>
        ...
        /* 👑 關鍵修正：讓所有區塊標題在被點擊時，精準停在導覽列下方不被遮擋 */
        h2 {
...
with st.container():
    ...
    try:
        ...
        st.info("💡 提示：請將 `contact_chart.png` 圖檔上傳至 GitHub 倉庫中以顯示圖片。")
...
# 頁尾
st.markdown("---")
st.markdown("<div style='text-align: center; color: #7f8782; padding: 20px;'>🔗 <a href='https://colab.research.google.com/drive/1CZVOzrgRb-PzNwHQQsQw9RfnB5_xaiKo?usp=sharing' target='_blank' style='color: #6b4f4f; text-linejoin: round; text-decoration: none;'>點此前往 Google Colab 完整分析筆記[cite: 1]</a></div>", unsafe_allow_html=True)
